  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row gap-8 lg-px-16 ">
        <div className="basis-1/4 md:basis-[33.3%] pt-5 text-white">
          ...
          <ul className="flex flex-col">
            <li>
              {' '}
              <Link href="" className="font-light leading-10 hover:font-medium">
                About Us
              </Link>
            </li>
            <li>
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between pt-10">
        <span>
          <p>Copyright © 2023 TravelandMeal</p>
        </span>
        <div className="pt-10 lg:pt-0">
          <div className="flex flex-cols-3 space-x-4">
            ...
            <div className="bg-white w-[20%] h-[20%]">
              <Image
                src="/Assets/Images/verve logo.png"
                alt="secure payment gateways"
                width={100}
                height={100}
                className="pt-2 lg:pt-2 md:pt-3 "
              />
            </div>
            <div className="bg-white w-[20%] h-[20%]">
              <Image
                ...
                width={100}
                height={100}
                className="pt-3 lg:pt-2 md:pt-4"
              />
            </div>
          </div>
        </div>
