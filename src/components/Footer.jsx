...
<div className="basis-1/4 md:basis-2/4 pt-5 text-white">
...
<div className="basis-1/4 pt-5 md:basis-2/4">
  ...
  <div className="flex flex-row gap-4 pt-5 text-3xl lg:text-4xl">
       ...
       <div className="pt-10 lg:pt-0">
        ...
        <div className="bg-white">
         ...
         width={100} height={100} className="pt-2 lg:pt-3 md:pt-3" /> 
         </div>
         <div className="bg-white"> 
         <Image src="/Assets/Images/visa logo.png" alt="secure payment gateways"
         width={100} height={100} className="pt-3 lg:pt-4 md:pt-4" /> 
         </div>
        </div>
